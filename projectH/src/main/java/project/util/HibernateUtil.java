	...
	public static SessionFactory getSessionFactory() {
		if( sessionFactory==null ) {
			try {
				...
				settings.put(Environment.URL, "jdbc:mariadb://localhost:3306/estoque");
				...
				// inserir nova linha para cada classe de modelo a ser persistida
